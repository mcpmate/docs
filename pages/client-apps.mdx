...
MCPMate automatically detects and manages connections to MCP-compatible applications on your system.

<div className="placeholder-screenshot">
  📸 Client Apps list view screenshot placeholder
</div>
...
<CardGroup cols={2}>
  ...
  <Card title="Cherry Studio" icon="cherry">
